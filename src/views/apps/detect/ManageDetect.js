    ...
    axios.post(`${url}/obj-detector/?web_URL=${infoDetect.web_Url}&conf=${infoDetect.conf}&iou=${infoDetect.iou}&dtViolence=${infoDetect.dtViolence}&dtWeapon=${infoDetect.dtWeapon}&dtAccident=${infoDetect.dtAccident}`
      , {
        ...
        if (n % 2 === 0) {
          ...
          for (let i = 0; i < n; i += 2) {
            const img1 = images[i].img_processed 
            const img2 = images[i + 1].img_processed 
          ...
          for (let i = 0; i < halfLength; i++) {
            const img1 = images[i].img_processed 
            const img2 = (i + halfLength < n) ? images[i + halfLength].img_processed  : null
    ...
    <Fragment>
      <Card>
        ...
        <Button className='justify-content-end cursor-pointer' size={17} color='primary' onClick={handleClick}>Mở hưỡng dẫn cấu hình</Button>
          ...
          {/* <Button className='justify-content-end cursor-pointer' size={17} color='primary' >HDCH</Button> */}
          {/* <StatsHorizontal icon={<UncontrolledDropdown>
            ...
            <DropdownMenu end>
              Nhập đường dẫn tới trang web và  các tham số cấu hình, lưu ý các ngưỡng là số thập phân từ 0 đến 1.
        ...
        <Row className=' mx-0'>
        <div >
  {isTextVisible && <p>Nhập đường dẫn tới trang web và  các tham số cấu hình, lưu ý các ngưỡng là số thập phân từ 0 đến 1.</p>}
  </div>
        </Row>
               <Row className=' mx-0'>
